...
const AccountDelete = () => {
    ...
    const { id, nickname, email} = useSelector((state) => state.members);
        ...
        <div className='w-600 h-800 m-auto place-content-center'>
            ...
            <div className='h-80'>
                ...
                <div className='flex p-2 h-20 items-center'>
                    <label className='p-4 flex justify-start  w-48'>NICKNAME</label>
                ...
                <div className='flex p-2 h-20  items-center'>
                    ...
                    <p className='p-4 w-96 flex justify-center'>{email}</p>
                </div>
            </div>
