                    ...
                    <ModalBody>
                        <div>
                            ...
                            <div className='w-400 h-24 flex justify-center '>
                                    <Button color={isFindingId ? "yellow" : "white"} onClickHandler={switchToFindId} text={"아이디 찾기"} type={"button"} />
                                    <Button color={isFindingId ? "white" : "yellow"} onClickHandler={switchToFindPwd} text={"비밀번호 찾기"} type={"button"} />
                            </div>
                            ...
                            <div>
                                {isFindingId ? (
                                    <div className='flex gap-2 h-32 justify-center'>
                                        <div>
                                            <Input widthSize={"200"} placeholder={"가입시 등록한 이메일을 입력하세요."} />    
                                        </div>
                                        <div>
                                            <select className="border w-48 h-10 rounded-md shadow-sm font-nanum-squareL text-sm p-1" onChange={hadleDomainChange}>
                                    ...
                                    <div className='flex h-32 gap-2 place-content-between justify-center'>
                                        ...
                                        <div>
                                            <Button color={"gray"} onClickHandler={handleModal} text={"인증번호 발송"} type={"button"}/>
                                        </div>
                                    </div>
                                )}
