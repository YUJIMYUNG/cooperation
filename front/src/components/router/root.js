...
const NicknameModify = lazy(() =>
  import("../../components/mypages/nicknameModify")
);
const PasswordModify = lazy(() =>
  import("../../components/mypages/passwordModify")
);
const AccountDelete = lazy(() =>
  import("../../components/mypages/accountDelete")
);
const Tasks = lazy(() => import("../../Pages/tasks/tasks"));
const UserInformation = lazy(() =>
  import("../../components/mypages/userInformation")
);
...
const Layout = () => {
  ...
  const { idx } = useSelector((state) => state.members);
  ...
  if (modalType === "login") {
    modalContent = (
      <LoginModal
        ...
        switchToFindIdPwd={switchToFindIdPwd}
    ...
    modalContent = (
      <RegisterModal onClose={handleModal} switchToLogin={switchToLogin} />
    );
